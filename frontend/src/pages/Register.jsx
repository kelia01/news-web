...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(data.message || "Kwandikisha umukoresha ntabwo bikunze.");
      }

      setSuccess("Kwijandikisha byagenze neza! Urayoborwa ahabarizwa kwinjira...");
      setTimeout(() => {
        navigate("/login");
      }, 2000);
    } catch (err) {
    ...
    <div style={{ minHeight: "100vh", backgroundColor: "#f8fafc", display: "flex", alignItems: "center", justifyContent: "center", padding: "48px 24px" }}>
      ...
      <div style={{ display: "flex", maxWidth: "900px", width: "100%", backgroundColor: "#fff", border: "1px solid #e2e8f0", boxShadow: "0 4px 32px rgba(15,23,42,0.08)" }}>
        ...
        <div style={{
          ...
          <div>
            ...
            <h2 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: "1.7rem", fontWeight: 800, color: "#ffffff", lineHeight: 1.3, marginBottom: "16px" }}>
              Tanga umusanzu<br />wawe uyu munsi
            </h2>
            <p style={{ fontFamily: "'Source Serif 4', Georgia, serif", color: "#cbd5e1", lineHeight: 1.7, fontSize: "0.92rem" }}>
              Iyandikishe nk'umunyamakuru maze utange umusanzu mu gukwirakwiza amakuru y'impamo muri Bagi News.
            </p>
          </div>
        ...
        <div style={{ flex: 1, padding: "56px 48px" }}>
          ...
          {success && (
            <div style={{ marginBottom: "20px", padding: "12px 16px", backgroundColor: "#f0fdf4", border: "1px solid #bbf7d0", display: "flex", gap: "10px", alignItems: "flex-start" }}>
              <AlertCircle size={16} style={{ color: "#16a34a", flexShrink: 0, marginTop: "1px" }} />
              <span style={{ fontFamily: "Inter, sans-serif", fontSize: "0.83rem", color: "#14532d" }}>{success}</span>
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
            <div>
              ...
              <div style={{ position: "relative" }}>
                ...
                <input
                  ...
                  placeholder="Amazina yanyu yombi"
                  style={inputStyle}
            ...
            >
              {loading ? (
                <><Loader2 size={16} style={{ animation: "spin 1s linear infinite" }} /> Biracyiyandikisha...</>
              ) : "Iyandikishe"}
            </button>
          </form>
